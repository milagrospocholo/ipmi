...
function preload() {
  ...
  imagenes = [];
  for (let i = 0; i < 27; i++) {
    imagenes [i] = loadImage ('data/img-' + i + '.jpg'); // Ajusta el formato según tus archivos
...
function mostrarEstado(estado) {
  ...
  if ([1, 5, 9, 17, 25].includes(estado)) {
    circuloa(410, 410, 40);
    circulob(260, 410, 40);
  }
...
sonido.play();
  ...
  //estas tienen que ir a un estado nuevo que va a ser el de los creditos 
  //} else if (estado == 22 && mouseEnCirculo( 580, 420, 40)) {
  //  estado = 26 //ultimo final y va a los creditos
  //} else if (estado == 23 && mouseEnCirculo( 580, 420, 40)) {
  //  estado = 26 //ultimo final y va a los creditos
  //} else if (estado == 24 && mouseEnCirculo( 580, 420, 40)) {
  //  estado = 26 //ultimo final y va a los creditos
